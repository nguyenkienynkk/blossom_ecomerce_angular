...
export class OrderComponent implements OnInit {
  ...
  orderForm: FormGroup;  // đối tượng để quản lý dữ liệu của form
  cartItems: {
    product: Product;
    quantity: number
  }[] = [];
  ...
  constructor(
    ...
    this.orderForm = this.fb.group({
      fullname: ['Nguyễn Khắc Kiên', Validators.required], // fullname là FormControl bắt buộc      
      email: ['nguyenkien@gmail.com', [Validators.email]], // Sử dụng Validators.email cho kiểm tra định dạng email
  ...
  placeOrder() {
    ...
    if (this.orderForm.valid) {
      //Gán giá trị từ form vào orderData
